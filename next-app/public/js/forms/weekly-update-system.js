    ...
    async loadUserNorthStar(username) {
        try {
            ...
            const apiUrl = (typeof API_CONFIG !== 'undefined' && API_CONFIG.API_BASE_URL) 
                ? `${API_CONFIG.API_BASE_URL}/api/user/${username}/north-star`
                : `/api/user/${username}/north-star`;
...
class WeeklyUpdateApp {
    ...
    async extractBullets() {
        try {
            ...
            const apiUrl = (typeof API_CONFIG !== 'undefined' && API_CONFIG.API_BASE_URL) 
                ? `${API_CONFIG.API_BASE_URL}/api/extract-bullets`
                : '/api/extract-bullets';
            const response = await fetch(apiUrl, {
                method: 'POST',
                headers: {
    ...
    async saveChanges() {
        try {
            ...
            const apiUrl = (typeof API_CONFIG !== 'undefined' && API_CONFIG.API_BASE_URL) 
                ? `${API_CONFIG.API_BASE_URL}/api/save-weekly-update`
                : '/api/save-weekly-update';
            const response = await fetch(apiUrl, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
            ...
            try {
                ...
                const summaryApiUrl = (typeof API_CONFIG !== 'undefined' && API_CONFIG.API_BASE_URL) 
                    ? `${API_CONFIG.API_BASE_URL}/api/generate-user-summaries`
                    : '/api/generate-user-summaries';
